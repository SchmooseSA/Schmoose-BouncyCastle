...
namespace Org.BouncyCastle.Crypto.Agreement.Srp
{
	...
	public class Srp6Server
	{
	    ...
	    protected IBigInteger v;

	    protected SecureRandom random;
	    protected IDigest digest;

	    protected IBigInteger A;

	    protected IBigInteger privB;
	    protected IBigInteger pubB;
	     ...
	     */
	    public virtual void Init(IBigInteger N, IBigInteger g, IBigInteger v, IDigest digest, SecureRandom random)
	    {
	        this.N = N;
	        this.g = g;
	        this.v = v;
