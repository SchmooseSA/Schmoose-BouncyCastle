...
namespace Org.BouncyCastle.Crypto.Tls
{
		...
		: TlsKeyExchange
	{
		...
		protected IAsymmetricKeyParameter serverPublicKey = null;
			...
			DHPrivateKeyParameters privateKey)
		{
			...
			IBigInteger agreement = dhAgree.CalculateAgreement(dhAgreeServerPublicKey);
			return BigIntegers.AsUnsignedByteArray(agreement);
		}

		protected virtual IAsymmetricCipherKeyPair GenerateDHKeyPair(DHParameters dhParams)
		{
