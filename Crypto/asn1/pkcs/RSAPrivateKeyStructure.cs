...
namespace Org.BouncyCastle.Asn1.Pkcs
{
        ...
        : Asn1Encodable
    {
        ...
        private readonly IBigInteger privateExponent;
        private readonly IBigInteger prime1;
        private readonly IBigInteger prime2;
        private readonly IBigInteger exponent1;
        private readonly IBigInteger exponent2;
        private readonly IBigInteger coefficient;
		...
		public RsaPrivateKeyStructure(
            ...
            IBigInteger prime1,
            IBigInteger prime2,
            IBigInteger exponent1,
            IBigInteger exponent2,
            IBigInteger coefficient)
        {
        ...
        public IBigInteger Prime1
		{
			get { return prime1; }
		}

        public IBigInteger Prime2
		{
			get { return prime2; }
		}

        public IBigInteger Exponent1
		{
			get { return exponent1; }
		}

        public IBigInteger Exponent2
		{
			get { return exponent2; }
		}

        public IBigInteger Coefficient
		{
