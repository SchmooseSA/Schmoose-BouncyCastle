...
namespace Org.BouncyCastle.Asn1.Sec
{
	public sealed class SecNamedCurves
	{
		...
		private static IBigInteger FromHex(
			string hex)
		{
			...
			: X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				IBigInteger a = FromHex("003088250CA6E7C7FE649CE85820F7");
				IBigInteger b = FromHex("00E8BEE4D3E2260744188BE0E9C723");
			...
			: X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				IBigInteger a = FromHex("00689918DBEC7E5A0DD6DFC0AA55C7");
				IBigInteger b = FromHex("0095E9A9EC9B297BD4BF36E059184F");
			...
			: X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				IBigInteger a = FromHex("07A11B09A76B562144418FF3FF8C2570B8");
				IBigInteger b = FromHex("0217C05610884B63B9C6C7291678F9D341");
			...
			: X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				IBigInteger a = FromHex("03E5A88919D7CAFCBF415F07C2176573B2");
				IBigInteger b = FromHex("04B8266A46C55657AC734CE38F018F2192");
			...
			: X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				IBigInteger a = BigInteger.ValueOf(1);
				IBigInteger b = BigInteger.ValueOf(1);
				byte[] S = null;
			...
			: X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				IBigInteger a = FromHex("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2");
				IBigInteger b = FromHex("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9");
			...
			: X9ECParametersHolder
		{
			...
			{
				IBigInteger a = BigInteger.ValueOf(1);
				IBigInteger b = FromHex("020A601907B8C953CA1481EB10512F78744A3205FD");
			...
			: X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				IBigInteger a = FromHex("0017858FEB7A98975169E171F77B4087DE098AC8A911DF7B01");
				IBigInteger b = FromHex("00FDFB49BFE6C3A89FACADAA7A1E5BBC7CC1C2E5D831478814");
			...
			: X9ECParametersHolder
		{
			...
			protected override X9ECParameters CreateParameters()
			{
				IBigInteger a = FromHex("0163F35A5137C2CE3EA6ED8667190B0BC43ECD69977702709B");
				IBigInteger b = FromHex("00C9BB9E8927D4D64C377E2AB2856A5B16E3EFB7F61D4316AE");
			...
			: X9ECParametersHolder
		{
			...
			{
				IBigInteger a = BigInteger.ValueOf(1);
				IBigInteger b = FromHex("0066647EDE6C332C7F8C0923BB58213B333B20E9CE4281FE115F7D8F90AD");
			...
			: X9ECParametersHolder
		{
			...
			{
				IBigInteger a = BigInteger.ValueOf(1);
				IBigInteger b = FromHex("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5");
			...
			: X9ECParametersHolder
		{
			...
			{
				IBigInteger a = BigInteger.ValueOf(1);
				IBigInteger b = FromHex("0021A5C2C8EE9FEB5C4B9A753B7B476B7FD6422EF1F3DD674761FA99D6AC27C8A9A197B272822F6CD57A55AA4F50AE317B13545F");
			...
			: X9ECParametersHolder
		{
			...
			{
                IBigInteger a = BigInteger.ValueOf(1);
                IBigInteger b = FromHex("02F40E7E2221F295DE297117B7F3D62F5C6A97FFCB8CEFF1CD6BA8CE4A9A18AD84FFABBD8EFA59332BE7AD6756A66E294AFD185A78FF12AA520E4DE739BACA0C7FFEFF7F2955727A");
