...
namespace Org.BouncyCastle.Asn1
{
    ...
    {
        private static readonly Regex _oidRegex = new Regex(@"\A[0-2](\.[0-9]+)+\z");
        ...
        public DerObjectIdentifier(string identifier)
        {
            ...
            if (!_oidRegex.IsMatch(identifier))
        ...
        private static void WriteField(Stream outputStream, IBigInteger fieldValue)
        {
        ...
        protected override bool Asn1Equals(Asn1Object asn1Object)
        {
            ...
            return other != null && this._identifier.Equals(other._identifier);
        }
            ...
            for (int a = 0, i = 0; i < split.Length; i++)
            {
                ...
                switch (i)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        bytes.Add((byte)(40 * a + int.Parse(split[1])));
                        break;
                    default:
                        var b = int.Parse(split[i]);
                        if (b < 128)
                        {
                            bytes.Add((byte) b);
                        }
