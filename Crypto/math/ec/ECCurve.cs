...
namespace Org.BouncyCastle.Math.EC
{
	...
	public abstract class ECCurve
	{
        ...
        public abstract ECPoint CreatePoint(IBigInteger x, IBigInteger y, bool withCompression);
    ...
    {
        private readonly IBigInteger q;
            ...
            IBigInteger X1)
		{
            ...
            IBigInteger betaValue = beta.ToBigInteger();
    ...
    public class F2mCurve : ECCurveBase
    {
		 ...
		 */
        private readonly IBigInteger n;

		/**
		 * The cofactor of the curve.
		 */
        private readonly IBigInteger h;
