...
namespace Org.BouncyCastle.Math.EC
{
	...
	{
        public static ECPoint SumOfTwoMultiplies(ECPoint P, IBigInteger a,
            ECPoint Q, IBigInteger b)
		{
			ECCurve c = P.Curve;
			if (!c.Equals(Q.Curve))
		...
		*/
        ...
        private static ECPoint ImplShamirsTrick(ECPoint P, IBigInteger k,
            ECPoint Q, IBigInteger l)
		{
