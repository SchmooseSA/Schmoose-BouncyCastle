...
namespace Org.BouncyCastle.Bcpg.OpenPgp
{
    ...
    public class PgpPublicKeyRing : PgpKeyRing, IPgpPublicKeyRing
    {
        ...
        {
            this._keys = Platform.CreateArrayList();
        ...
        {
            return new EnumerableProxy(_keys);
        }
