...
//			+ "QIeLZ4j3a6ividZl344UH+UPUE7xJxlYGuy7ejTsqRR");
		...
		private IAsymmetricKeyParameter dudPublicKey = new DudPublicKey();
			...
			byte[]	bytes)
		{
			...
			try
			{
				...
				IAsymmetricKeyParameter k = cert.GetPublicKey();
...
//			pubKey = fact.generatePublic(pubKeySpec);
		...
		private void createPssCert(
			string algorithm)
		{
			IAsymmetricCipherKeyPair keyPair = GenerateLongFixedKeys();

			IAsymmetricKeyParameter privKey = keyPair.Private;
		...
		private static IAsymmetricCipherKeyPair GenerateLongFixedKeys()
		{
