...
//			IAsymmetricKeyParameter sKey = f.generatePrivate(priKey);
//			IAsymmetricKeyParameter vKey = f.generatePublic(pubKey);
...
//				ECPointUtil.DecodePoint(curve,
		...
		protected IBigInteger[] derDecode(
			byte[] encoding)
		{
			Asn1Sequence s = (Asn1Sequence) Asn1Object.FromByteArray(encoding);

			return new IBigInteger[]
			{
