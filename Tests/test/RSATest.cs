...
//			PublicKey   pubKey = fact.generatePublic(pubKeySpec);
			...
			IAsymmetricKeyParameter pubKey = pubKeySpec;

//			PrivateKey  priv2048Key = fact.generatePrivate(priv2048KeySpec);
//			PublicKey   pub2048Key = fact.generatePublic(pub2048KeySpec);
			IAsymmetricKeyParameter priv2048Key = priv2048KeySpec;
			IAsymmetricKeyParameter pub2048Key = pub2048KeySpec;
...
//			PublicKey   isoPubKey = fact.generatePublic(isoPubKeySpec);
			IAsymmetricKeyParameter isoPrivKey = isoPrivKeySpec;
			IAsymmetricKeyParameter isoPubKey = isoPubKeySpec;
			...
			IAsymmetricCipherKeyPair kp = keyPairGen.GenerateKeyPair();
