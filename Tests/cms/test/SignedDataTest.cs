...
//		private static X509Certificate reciCert;
		...
		private static IAsymmetricCipherKeyPair signGostKP;
		private static X509Certificate signGostCert;

		private static IAsymmetricCipherKeyPair signDsaKP;
		private static X509Certificate signDsaCert;

		private static IAsymmetricCipherKeyPair signECGostKP;
		private static X509Certificate signECGostCert;

		private static IAsymmetricCipherKeyPair signECDsaKP;
...
//			KeyPair             kp = new KeyPair(keyFact.generatePublic(pubSpec), keyFact.generatePrivate(privSpec));
			IAsymmetricCipherKeyPair kp = new AsymmetricCipherKeyPair(
