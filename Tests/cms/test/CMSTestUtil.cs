...
namespace Org.BouncyCastle.Cms.Tests
{
	public class CmsTestUtil
	{
		...
		public static IBigInteger serialNumber;
...
//			return (X509AttributeCertificate) parser.Read();
		...
		public static IAsymmetricCipherKeyPair MakeKeyPair()
		{
			return Kpg.GenerateKeyPair();
		}

		public static IAsymmetricCipherKeyPair MakeGostKeyPair()
		{
			return GostKpg.GenerateKeyPair();
		}

		public static IAsymmetricCipherKeyPair MakeDsaKeyPair()
		{
			return DsaKpg.GenerateKeyPair();
		}

		public static IAsymmetricCipherKeyPair MakeECGostKeyPair()
		{
			return ECGostKpg.GenerateKeyPair();
		}

		public static IAsymmetricCipherKeyPair MakeECDsaKeyPair()
		{
		...
		public static X509Certificate MakeCACertificate(IAsymmetricCipherKeyPair _subKP,
			string _subDN, IAsymmetricCipherKeyPair _issKP, string _issDN)
		{
