...
//		private static X509Certificate origCert;
		...
		private static IAsymmetricCipherKeyPair reciECKP2;
		...
		private static void ConfirmDataReceived(RecipientInformationStore recipients,
			byte[] expectedData, X509Certificate reciCert, IAsymmetricKeyParameter reciPrivKey)
		{
		...
		{
			IAsymmetricKeyParameter privKey = PrivateKeyFactory.CreateKey(ecKeyAgreeKey);
