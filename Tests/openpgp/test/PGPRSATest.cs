...
//		private static readonly byte[] fingerprintCheck = Base64.Decode("CTv2");
		...
		private void EmbeddedJpegTest()
		{
			...
			IPgpPublicKey nKey = PgpPublicKey.AddCertification(pubKey, uVec, sig);
		...
		public override void PerformTest()
        {
			...
			IAsymmetricKeyParameter pubKey = pgpPub.GetPublicKey().GetKey();
            ...
            IAsymmetricKeyParameter pubKeyV3 = pgpPub.GetPublicKey().GetKey();
            ...
            IPgpPrivateKey pgpPrivKey = pgpPriv.GetSecretKey().ExtractPrivateKey(pass);
...
//                c.Init(Cipher.DECRYPT_MODE, pgpPrivKey.GetKey());
            ...
            IPgpPublicKey puK = pgpPriv.GetSecretKey(encP.KeyId).PublicKey;
