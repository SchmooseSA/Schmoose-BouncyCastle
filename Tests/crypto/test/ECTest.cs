...
namespace Org.BouncyCastle.Crypto.Tests
{
		...
		: SimpleTest
	{
		...
		*/
		...
		{
			IBigInteger r = new BigInteger("3342403536405981729393488334694600415596881826869351677613");
			IBigInteger s = new BigInteger("5735822328888155254683894997897571951568553642892029982342");
		...
		public void TestECDsaP256Sha256()
		{
			...
			IBigInteger r = new BigInteger("97354732615802252173078420023658453040116611318111190383344590814578738210384");
			IBigInteger s = new BigInteger("98506158880355671805367324764306888225238061309262649376965428126566081727535");
		...
		public void TestECDsaP521Sha512()
		{
			...
			IBigInteger r = new BigInteger("1368926195812127407956140744722257403535864168182534321188553460365652865686040549247096155740756318290773648848859639978618869784291633651685766829574104630");
