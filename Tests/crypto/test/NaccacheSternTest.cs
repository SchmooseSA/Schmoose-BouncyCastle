...
namespace Org.BouncyCastle.Crypto.Tests
{
		...
		: SimpleTest
	{
		...
		static readonly IBigInteger a = BigInteger.ValueOf(101);
		static readonly IBigInteger u1 = BigInteger.ValueOf(3);
		static readonly IBigInteger u2 = BigInteger.ValueOf(5);
		static readonly IBigInteger u3 = BigInteger.ValueOf(7);
		static readonly IBigInteger b = BigInteger.ValueOf(191);
		static readonly IBigInteger v1 = BigInteger.ValueOf(11);
		static readonly IBigInteger v2 = BigInteger.ValueOf(13);
		static readonly IBigInteger v3 = BigInteger.ValueOf(17);

		static readonly IBigInteger sigma
			= u1.Multiply(u2).Multiply(u3).Multiply(v1).Multiply(v2).Multiply(v3);

		static readonly IBigInteger p
			= BigInteger.Two.Multiply(a).Multiply(u1).Multiply(u2).Multiply(u3).Add(BigInteger.One);

		static readonly IBigInteger q
			= BigInteger.Two.Multiply(b).Multiply(v1).Multiply(v2).Multiply(v3).Add(BigInteger.One);

		static readonly IBigInteger n = p.Multiply(q);

		static readonly IBigInteger phi_n
			= p.Subtract(BigInteger.One).Multiply(q.Subtract(BigInteger.One));

		static readonly IBigInteger g = BigInteger.ValueOf(131);

		static readonly IList smallPrimes = new ArrayList();

		// static final IBigInteger paperTest = BigInteger.ValueOf(202);

		static readonly string input = "4e6f77206973207468652074696d6520666f7220616c6c20676f6f64206d656e";

		static readonly IBigInteger paperTest = BigInteger.ValueOf(202);
