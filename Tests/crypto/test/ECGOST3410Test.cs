...
namespace Org.BouncyCastle.Crypto.Tests
{
		...
		: SimpleTest
	{
		...
		*/
		...
		IBigInteger s = new BigInteger("574973400270084654178925310019147038455227042649098563933718999175515839552");
		...
		private void ecGOST3410_TEST()
		{
			...
			IBigInteger[] sig = ecgost3410.GenerateSignature(message);
		...
		public void ecGOST3410_AParam()
		{
			...
			IBigInteger mod_p = new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639319"); //p
		...
		private void ecGOST3410_BParam()
		{
			...
			IBigInteger mod_p = new BigInteger("57896044618658097711785492504343953926634992332820282019728792003956564823193"); //p
		...
		private void ecGOST3410_CParam()
		{
			...
			IBigInteger mod_p = new BigInteger("70390085352083305199547718019018437841079516630045180471284346843705633502619"); //p
